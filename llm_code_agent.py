...
if __name__ == "__main__":
    ...
    #     1. check each bigcodebench folder, check the test function 
    #     2. make a solution file called {model_name}_problem number
    #     3. modify the test file import the solution, so I can run the test file 
    #     4. do 1-3 for all folders
    #     5. generate a sh so I only need to execute sh, and I can see the test result for all test files
    #     """
    # )
    # print(f"\n{'='*60}\nFinal Result:\n{result}\n{'='*60}")
